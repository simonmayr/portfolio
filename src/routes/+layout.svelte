...
<svelte:head>
	...
	/>
	<meta property="og:title" content="Simon Mayr | Webseiten ✓ Typo3 ✓ Design" />
	<meta
		property="og:description"
		content="Hallo, mein Name ist Simon Mayr und ich bin ein leidenschaftlicher Webentwickler aus Tirol."
	/>
